  ...
  return (
    <footer className="border-t border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-center items-center"> {/* Center the content */}
          
          <div className="mb-4 md:mb-0 text-center"> {/* Center the text horizontally */}
            <h2 className="text-xl font-bold">Job Hunt</h2>
            <p className="text-sm">© 2025 Your Company. All rights reserved.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0 justify-center"> {/* Center the icons horizontally */}
